...
export const Route = createFileRoute("/thanks")({
  head: () => ({
    meta: [
      { title: "Task Partners | Paiement confirmé" },
      {
        name: "description",
        content: "Votre paiement Task Partners a été confirmé. Accédez à votre tableau de bord et aux ressources incluses.",
      },
      ...
      <main className="tp-thanks">
        <div className="tp-shell">
          ...
          <section className="tp-card" aria-labelledby="thanks-title">
            ...
            <h1 id="thanks-title" className="tp-title">Paiement confirmé</h1>
            <p className="tp-subtitle">Bienvenue sur Task Partners</p>

            <div className="tp-copy">
              <p>Votre paiement a été confirmé avec succès et votre compte Task Partners est maintenant prêt.</p>
              <p>Vous pouvez maintenant vous connecter à votre tableau de bord et accéder à toutes les ressources incluses avec votre compte.</p>
            </div>

            <div className="tp-button-row">
              <a className="tp-primary" href="https://task-part-main.vercel.app/tasks-app" aria-label="Accéder au tableau de bord Task Partners">
                Go to Dashboard
            ...
            <section className="tp-support" aria-labelledby="support-title">
              <h2 id="support-title">Besoin d’aide ?</h2>
              <p>Pour l’accès au compte, la facturation, les demandes de remboursement ou le support technique, contactez notre équipe.</p>
              <a className="tp-email" href="mailto:support@taskpartners.online">support@taskpartners.online</a>
            </section>

            <p className="tp-note">Le paiement sera traité par Digistore24.com.</p>
          </section>

          <footer className="tp-footer" aria-label="Footer links">
            <a href="https://taskpartners.online/privacy">Politique de confidentialité</a>
            <a href="https://taskpartners.online/terms">Conditions d’utilisation</a>
            <a href="https://taskpartners.online/refund">Politique de remboursement</a>
