...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Politique de confidentialité | Task Partners" },
      { name: "description", content: "Politique de confidentialité de Task Partners." },
    ],
  }),
...
function PrivacyPage() {
  return (
    <LegalLayout label="Juridique" title="Politique de confidentialité">
      ...
      <Section title="Informations que nous collectons">
      ...
      <Section title="Comment nous utilisons les informations">
