...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Politique de remboursement | Task Partners" },
      { name: "description", content: "Politique de remboursement de Task Partners." },
    ],
  }),
...
function RefundPage() {
  return (
    <LegalLayout label="Politique" title="Politique de remboursement">
      ...
      <Section title="Traitement">
        <p>Approved refunds are processed through the original payment processor. Processusing times may vary depending on the payment method and financial institution.</p>
      </Section>
      <Section title="Comment demander un remboursement">
        <p>Email <a className="font-bold text-[#2563EB]" href="mailto:support@taskpartners.online">support@taskpartners.online</a> with the subject line "Demande de remboursement" and include your purchase email.</p>
      </Section>
    </LegalLayout>
  );
}
